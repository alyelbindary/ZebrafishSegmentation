...
"""
Helper functions in order to change .nrrd data orientation in different ways
"""
...
def generate_data_folder (tif_file_path, nrrd_file_path, zebrafish_number) :
    """
    This function takes in the .tif file path, the .nrrd file path as well as a number
    to identify the corresponding zebrafish. It uses the two previous functions in
    order to get the desired data format

    Inputs : 
        - tif_file_path : .tif file path
        - nrrd_file_path : .nrrd file path
        - zebrafish_number : zebrafish identifier
